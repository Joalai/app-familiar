...
function buildHome(){
 ...
 dash.querySelectorAll('[data-home-open]').forEach(b=>b.onclick=()=>b.dataset.homeOpen==='upcoming'?goUpcoming():openSection(b.dataset.homeOpen));
}
