const APP_PATCH_VERSION='2026.09.14.1';
...
self.addEventListener('fetch',event=>{
  ...
  event.respondWith((async()=>{
    try{
      ...
      const scripts=['app-enhancements.js','calendar-races-update.js','packing.js','navigation-fix.js','home-dashboard.js','home-upcoming-races.js','packing-smart.js','smart-features.js','weekly-auto.js','notification-fix.js','family-upgrades.js'];
